...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/stijnmeijer/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/stijnmeijer/btcd/blockchain/fullblocktests
```
