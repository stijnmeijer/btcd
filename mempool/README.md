...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/stijnmeijer/btcd/mempool)
...
```bash
$ go get -u github.com/stijnmeijer/btcd/mempool
```
